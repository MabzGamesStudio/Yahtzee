...
public class ScoringBoxFullHouse : ScoreCardBox
{
	...
	protected override void UpdateInformation()
	{
		...
		{
			UpdateDiceNumbers();
			textMeshPro.SetText(YahtzeeScoring.FullHouse(diceNumbers[0], diceNumbers[1], diceNumbers[2], diceNumbers[3], diceNumbers[4]).ToString());
		}
	}
